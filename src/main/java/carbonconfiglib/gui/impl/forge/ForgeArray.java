...
public class ForgeArray implements IArrayNode
{
	...
	public ForgeArray(ITextComponent name, ITextComponent tooltip, ReloadMode mode, DataType type, List<String> value, List<String> defaultValue, Supplier<List<Suggestion>> suggestions, Function<String, ParseResult<?>> isValid, Consumer<List<String>> saved) {
		this.name = name;
