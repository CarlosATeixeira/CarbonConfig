...
public class CarbonCompound implements ICompoundNode, IValueActions
{
	...
	public CarbonCompound(IReloadMode mode, CompoundData data, ITextComponent name, ITextComponent tooltip, String value, String defaultValue, Function<String, ParseResult<Boolean>> isValid, Supplier<List<Suggestion>> suggestions, Consumer<String> saveAction) {
		this.mode = mode;
		this.data = data;
		this.name = name;
