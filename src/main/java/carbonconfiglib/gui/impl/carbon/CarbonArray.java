...
public class CarbonArray implements IArrayNode, IValueActions
{
	...
	public CarbonArray(IReloadMode mode, ListData data, IChatComponent name, IChatComponent tooltip, String currentValue, String defaultValue, Function<String, ParseResult<Boolean>> isValid, Supplier<List<Suggestion>> suggestions, Consumer<String> saveAction) {
		this.mode = mode;
		this.data = data;
