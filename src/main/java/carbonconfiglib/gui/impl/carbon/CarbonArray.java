...
public class CarbonArray implements IArrayNode, IValueActions
{
	...
	public CarbonArray(IReloadMode mode, ListData data, IChatComponent name, IChatComponent tooltip, String currentValue, String defaultValue, Function<String, ParseResult<Boolean>> isValid, Supplier<List<Suggestion>> suggestions, BiConsumer<String, IValueActions> saveAction) {
		this.mode = mode;
		this.data = data;
