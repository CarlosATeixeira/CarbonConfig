...
public class CarbonValue implements IValueNode, IValueActions
{
	...
	public CarbonValue(IReloadMode mode, ITextComponent name, ITextComponent tooltip, DataType type, boolean forced, Supplier<List<Suggestion>> suggestions, String current, String defaultValue, Function<String, ParseResult<Boolean>> isValid, BiConsumer<String, IValueActions> saveAction) {
		this.mode = mode;
		this.name = name;
