...
public class CompoundElement extends ConfigElement
{
	...
	public void init() {
		super.init();
		textBox = addChild(new CarbonButton(0, 0, isArray() ? 190 : isCompound() ? 105 : 72, 18, new TranslationTextComponent("gui.carbonconfig.edit"), this::onPress), isArray() ? GuiAlign.CENTER : GuiAlign.RIGHT, 0);
	}
